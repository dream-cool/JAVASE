...
/**
 * @ Author   ：clt.
 * @ Date     ：Created in 7:31 2019/7/1
 */
public class OperandStack {

    public static void main(String[] args) {
//        System.out.println(nextExpre("a+b-a*((c+d)/e-f)+g"));
        System.out.println(nextExpre("a+b-a*((c+d)/e-f)+g"));
//        System.out.println(nextExpre("a*(b+c)-d"));
        System.out.println(result(nextExpre("312*((45+54)-65+454*(5441/22)*5)/10")));
        System.out.println(312*((45+54)-65+454*(5441/22)*5)/10);
//        System.out.println(strSpilt("a*(b+c)-d"));
    }
